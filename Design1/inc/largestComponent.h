/*******************************************************************************
 *  FILE NAME    : largestComponent.h
 *
 *  DESCRIPTION  : This file find largest component using recursion method and 
 Process all images one by one based on the implementation
 *
 *
 ******************************************************************************/
