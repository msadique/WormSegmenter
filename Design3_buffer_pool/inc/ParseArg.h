...
static int parse_opt(int key, char *arg) {
	...
	case 'R':
		wormArg->readThread = atoi(arg);
		cout<<"New  ReadThreads "<< arg<<endl;
		break;
...
void parse_arg(int argc, char **argv)
{
	...
	/*struct argp_option options[] = {
		...
		{ "readThread",            'R', "NUMBER",     OPTION_ARG_OPTIONAL,  "Number of threads. Read Image and Convert into Grayscale and Remaining Process" },
